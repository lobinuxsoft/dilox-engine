...
ExampleLayer::ExampleLayer()
	: Layer("ExampleLayer"), m_CameraController()
{
	...
	m_ChernoLogoTexture = DiloxGE::Texture2D::Create("assets/textures/ChernoLogo.png");
...
void ExampleLayer::OnEvent(DiloxGE::Event& e)
{
